...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white/70 backdrop-blur-[2px] py-4 px-4 md:px-8 lg:px-16 sticky top-0 z-50">
      ...
      {isMobileMenuOpen && (
        <div
          className="w-full h-screen absolute top-0 left-0 bg-[#00000025]"
          onClick={() => setIsMobileMenuOpen(false)}
        >
          <div
            className="px-2 h-max bg-white"
          ...
          >
            ...
            <div className="mt-4 flex flex-col gap-2 pb-2">
              <a
                href="/"
                className="px-4 py-2 text-gray-700 hover:text-orange-500 hover:bg-gray-50 rounded-lg transition-colors"
              >
                Home
              </a>
              <a
